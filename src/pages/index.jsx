...
function Home() {
  ...
  return (
    <Layout className="flex min-h-screen flex-wrap content-center items-center justify-center bg-light dark:bg-dark dark:text-light">
      ...
      <p className="p-3">
        Developer By{' '}
        <span className="bg-black p-1 font-bold text-white dark:bg-light dark:text-dark">
          Arif GEVENCİ
        </span>
